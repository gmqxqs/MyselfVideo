...
import com.shuyu.gsyvideoplayer.chillingvan.lib.muxer.IMuxer;
...
import com.shuyu.gsyvideoplayer.screening.listener.OnRequestMediaProjectionResultCallback;
...
public class DLNAPlayer {
    ...
    public void play(@NonNull final DLNAControlCallback callback) {
    ...
    public void seekTo(String time, @NonNull DLNAControlCallback callback) {
        final Service avtService = mDevice.findService(AV_TRANSPORT_SERVICE);
        Log.e("checkErrorBeforeExecute",checkErrorBeforeExecute(avtService, callback)+"");
    ...
    public void start(String time,final @NonNull DLNAControlCallback callback) {
    ...
    public void destroy() {
        Log.e("DLNAPlayer","mDLNAPlayer销毁");
        checkConfig();
        stopMirror();
     /*   try {
